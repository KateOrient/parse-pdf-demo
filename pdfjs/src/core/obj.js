...
class Catalog extends CatalogMain {
  constructor(pdfManager, xref) {
  ...
  getStructureData() {
    if (this.xref.root.has('StructTreeRoot')) {
      let structureObj = this.xref.root.get('StructTreeRoot');
      console.log('GET-------------------------------------------:');
      console.log(structureObj.get('K'));
      console.log(structureObj.get('ParentTree'));
      console.log(structureObj.get('ParentTreeNextKey'));
    }
  }
