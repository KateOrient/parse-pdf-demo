...
var PartialEvaluator = (function PartialEvaluatorClosure() {
  ...
  function PartialEvaluator({
                              pdfManager, xref, handler, pageIndex, idFactory,
  ...
  PartialEvaluator.prototype = {
    ...
    buildPaintImageXObject({
                             resources, image, isInline = false, operatorList,
                             cacheKey, imageCache,
    ...
    getOperatorList({
                      stream, task, resources, operatorList,
                      initialState = null,
                    }) {
      ...
      function getTextBoundingBox(glyphs) {
        ...
        let ascent = (mcTextState.font.ascent || 1) * mcTextState.fontSize;
              ...
              next(new Promise(function (resolveXObject, rejectXObject) {
                ...
                if (type.name === 'Form') {
                  ...
                  self.buildFormXObject(resources, xobj, null, operatorList,
                    task, stateManager.state.clone()).then(function () {
    ...
    getTextContent({
                     stream, task, resources, stateManager = null,
...
var EvaluatorPreprocessor = (function EvaluatorPreprocessorClosure() {
  ...
  var getOPMap = getLookupTableFactory(function (t) {
    ...
    t['Tr'] = {
      id: OPS.setTextRenderingMode, numArgs: 1,
      variableArgs: false,
    };
